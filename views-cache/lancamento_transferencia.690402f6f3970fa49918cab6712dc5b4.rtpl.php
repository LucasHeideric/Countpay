                    ...
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="col-md-5">
                            ...
                            <form action="/lancamento/transferencia" method="post" class="row g-4 pt-1 pb-4 d-flex justify-content-center">
                                ...
                                <div class="col-md-10">
                                    <label for="descricao_despesa" class="form-label">Conta que transferiu</label>
                                ...
                                <div class="col-md-10">
                                    <label for="descricao_receita" class="form-label">Conta que recebeu</label>
                                    <select class="form-select" name="id_conta_receita" id="contacartao_receita" required>
                                        <?php $counter1=-1;  if( isset($conta) && ( is_array($conta) || $conta instanceof Traversable ) && sizeof($conta) ) foreach( $conta as $key1 => $value1 ){ $counter1++; ?>
                                        <option><?php echo htmlspecialchars( $value1["apelido"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
                                        <?php } ?>
                                    </select>
