                      ...
                      <div class="col-md-7">
                        <form class="row g-4 pt-4 pb-4 d-flex justify-content-center">
                            ...
                            <div class="col-md-10">
                                ...
                                <input type="text" class="form-control" id="descricao_despesa" required>
                            </div>

                            <div class="col-md-3">
                                <label for="valor_despesa" class="form-label">Valor</label>
                                <input type="number" placeholder="R$ 00,00"  class="form-control" id="valor_despesa">
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" class="form-control" id="data_despesa" required>
                            </div>
